...
<template>
    ...
    <footer>
        <a href="#top">Inicio</a>
        <p>© 2025 Nahuel Spikerman - Todos los derechos reservados.</p>
    </footer>

    <!-- Sección Contacto -->
    <section id="contacto" class="seccion" style="padding:2rem; margin:2rem auto; max-width:900px;">
      <h2>Contacto</h2>
      <p> <strong>nahuelspikerman@gmail.com</strong></p>
    </section>
